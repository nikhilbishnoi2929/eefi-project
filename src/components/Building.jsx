...
const Building = () => {
  return (
    <div className="relative pb-24 lg:pb-0">
      <img
        className="max-w-[1210px] w-full absolute right-2 bottom-0"
        src={heroBg}
        alt="heroBg"
      />
      <img
      ...
      <div className="container mx-auto px-3 max-w-[1176px] mb-20 pb-20 lg:pb-0 lg:mb-0 relative">
        <div className="flex lg:flex-row flex-col xl:-mt-12 relative z-[1]">
          ...
          <img
            className="xl:max-w-[635px] h-[502px] xl:h-[876px] md:max-w-[450px] md:h-auto md:w-full absolute lg:relative top-24 md:top-0 right-0 -z-10 opacity-50 sm:opacity-70 w-[335px]  lg:opacity-100 pointer-events-none lg:pt-0 pt-9"
            src={imageHero}
            alt="imageHero"
          />
        </div>
